      ...
      <div className="container-horo-art">
        ...
        <div className="horoscopo-container horoscopo-container-text">
          ...
          <p className="bodyText">
            El Año Nuevo Chino de este 2021 será el Año del Búfalo o Buey, según el calendario chino este será un año
            próspero para todos los que nacieron bajo este signo. Se llenarán de buena energía en el campo de la
            finanzas y en sus próximos proyectos.
          </p>
        </div>
      </div>
    </article>
